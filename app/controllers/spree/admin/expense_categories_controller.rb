  ...
  def create
    ...
    respond_to do |format|
      if @admin_expense_category.save
        format.html { redirect_to @admin_expense_category, notice: 'Expense category was successfully created.' }
  ...
  def update
    ...
    respond_to do |format|
      if @admin_expense_category.update_attributes(params[:admin_expense_category])
        format.html { redirect_to @admin_expense_category, notice: 'Expense category was successfully updated.' }
        format.json { head :ok }
      else
