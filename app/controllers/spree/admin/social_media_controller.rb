  ...
  def create
    ...
    respond_to do |format|
      if @admin_social_medium.save
        format.html { redirect_to @admin_social_medium, notice: 'Social medium was successfully created.' }
  ...
  def update
    ...
    respond_to do |format|
      if @admin_social_medium.update_attributes(params[:admin_social_medium])
        format.html { redirect_to @admin_social_medium, notice: 'Social medium was successfully updated.' }
        format.json { head :ok }
      else
