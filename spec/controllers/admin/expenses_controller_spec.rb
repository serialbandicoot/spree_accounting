...
describe Admin::ExpensesController do
  ...
  # Admin::Expense. As you add validations to Admin::Expense, be sure to
  ...
  # Admin::ExpensesController. Be sure to keep this updated too.
  def valid_session
    {}
  end

  describe "GET index" do
    it "assigns all admin_expenses as @admin_expenses" do
      expense = Admin::Expense.create! valid_attributes
      get :index, {}, valid_session
      assigns(:admin_expenses).should eq([expense])
    end
  end
  ...
  describe "GET new" do
    it "assigns a new expense as @expense" do
      ...
      assigns(:expense).should be_a_new(Admin::Expense)
    end
  end
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved expense as @expense" do
        ...
        Admin::Expense.any_instance.stub(:save).and_return(false)
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested expense" do
        expense = Admin::Expense.create! valid_attributes
        # Assuming there are no other admin_expenses in the database, this
        # specifies that the Admin::Expense created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        Admin::Expense.any_instance.should_receive(:update_attributes).with({'these' => 'params'})
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the admin_expenses list" do
      expense = Admin::Expense.create! valid_attributes
      delete :destroy, {:id => expense.to_param}, valid_session
