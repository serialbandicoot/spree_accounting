...
describe Admin::SuppliersController do
  ...
  # Admin::Supplier. As you add validations to Admin::Supplier, be sure to
  ...
  # Admin::SuppliersController. Be sure to keep this updated too.
  def valid_session
    {}
  end

  describe "GET index" do
    it "assigns all admin_suppliers as @admin_suppliers" do
      supplier = Admin::Supplier.create! valid_attributes
      get :index, {}, valid_session
      assigns(:admin_suppliers).should eq([supplier])
    end
  end
  ...
  describe "GET new" do
    it "assigns a new supplier as @supplier" do
      ...
      assigns(:supplier).should be_a_new(Admin::Supplier)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Admin::Supplier" do
        expect {
          post :create, {:supplier => valid_attributes}, valid_session
        }.to change(Admin::Supplier, :count).by(1)
      end

      it "assigns a newly created supplier as @supplier" do
        post :create, {:supplier => valid_attributes}, valid_session
        assigns(:supplier).should be_a(Admin::Supplier)
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved supplier as @supplier" do
        ...
        Admin::Supplier.any_instance.stub(:save).and_return(false)
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested supplier" do
        supplier = Admin::Supplier.create! valid_attributes
        # Assuming there are no other admin_suppliers in the database, this
        # specifies that the Admin::Supplier created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        Admin::Supplier.any_instance.should_receive(:update_attributes).with({'these' => 'params'})
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the admin_suppliers list" do
      supplier = Admin::Supplier.create! valid_attributes
      delete :destroy, {:id => supplier.to_param}, valid_session
      response.should redirect_to(admin_suppliers_url)
    end
  end
